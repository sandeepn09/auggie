...
@NgModule({
  declarations: [MenuHeaderComponent, PmtCardComponent, ValidationPopoverComponent, SendTextModalComponent, NumberMaskComponent, ProviderModalComponent, BankModalComponent, PaymentModalComponent],
  imports: [
    CommonModule,
    FormsModule,
    IonicModule,
